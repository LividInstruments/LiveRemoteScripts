...
"""
class SpecialMonoStripComponent(ChannelStripComponentBase):
	...
	def update(self, *a, **k):
		super(SpecialMonoStripComponent, self).update()
		self._update_device_selection()
	...
	def _connect_parameters(self):
		#super(SpecialMonoStripComponent, self)._connect_parameters()
	...
	def _disconnect_parameters(self):
		...
		super(SpecialMonoStripComponent, self)._disconnect_parameters()
