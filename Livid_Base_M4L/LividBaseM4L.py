...
class LividBaseM4L(ControlSurface):
	...
	def __init__(self, c_instance):
		...
		with self.component_guard():
			...
			self.log_message("--------------= LividBaseM4L log BEGIN =--------------") 
